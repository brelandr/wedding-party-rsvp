...
**8.2.7** fixes Menu Breakdown meal chips on the Wedding Dashboard so labels stay readable with the Modern admin color scheme (dark text on light chips; no blue-on-blue). **8.2.6** registers the WordPress Abilities API category on `wp_abilities_api_categories_init` (WordPress 6.9+).
